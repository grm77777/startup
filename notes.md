...
Domain name information is accessed using Route 53. I registered under the domain name `lilplanner.click`. This domain name has been connected to my elastic IP address. 
